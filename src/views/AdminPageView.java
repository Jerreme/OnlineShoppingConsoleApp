...
public class AdminPageView extends Messenger {
    ...
    public void showOldProduct(Product oldProduct) {
        final String formatted = String.format(" - %s%s₱%s",
                oldProduct.getProductName(), generateSpaces(oldProduct.getProductName().length() + 1), oldProduct.getPrice());
        println(formatted);
    }

    public void showProductConfirmation(Product product) {
        final String formatted = String.format(" + %s%s₱%s",
                product.getProductName(), generateSpaces(product.getProductName().length() + 1), product.getPrice());
        println(formatted);
