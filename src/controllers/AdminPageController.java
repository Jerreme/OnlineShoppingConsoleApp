...
public class AdminPageController {
    ...
    public void modifyProduct() {
        ...
        final Product newProduct = new Product(productId, productDetails.getProductName(), productDetails.getPrice());
    ...
    private boolean isProductDetailsValid(Product oldProduct, Product newProduct) {
        ...
        if (ProductsManager.isProductExists(newProduct.getProductName())) {
